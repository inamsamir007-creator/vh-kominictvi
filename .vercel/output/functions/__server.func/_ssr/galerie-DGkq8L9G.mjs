...
import { X, C as ChevronLeft, b as ChevronRight } from "../_libs/lucide-react.mjs";
...
function GaleriePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen py-16 md:py-24 pb-20 md:pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.header, { initial: {
        opacity: 0,
        y: 20
      }, whileInView: {
        opacity: 1,
        ...
        once: true
      }, className: "max-w-2xl mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-[0.2em] text-ember", children: "Naše práce" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-2 text-4xl font-extrabold text-soot md:text-5xl", children: "Galerie realizací" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-lg text-muted-foreground", children: "Podívejte se na ukázky naší kominické práce — od běžného čištění přes frézování a vložkování komínů až po montáže na klíč v širokém okolí města Kryry." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4", children: galleryImages.map((img, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        scale: 0.95
      }, whileInView: {
        opacity: 1,
        ...
        delay: index % 10 * 0.05
      }, className: "break-inside-avoid relative group cursor-pointer overflow-hidden rounded-xl bg-muted", onClick: () => setSelectedIndex(index), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `/gallery/${img.src}`, alt: img.alt, loading: "lazy", className: "w-full object-cover transition-transform duration-500 group-hover:scale-105" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-soot/0 transition-colors duration-300 group-hover:bg-soot/20" })
      ] }, img.src)) })
    ] }),
    selectedIndex !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/95 p-4 backdrop-blur-sm", onClick: () => setSelectedIndex(null), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute top-6 right-6 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-2 transition-all", onClick: (e) => {
        e.stopPropagation();
        setSelectedIndex(null);
      }, "aria-label": "Zavřít", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-8 h-8" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute left-2 sm:left-4 md:left-10 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3 sm:p-4 transition-all", onClick: handlePrev, "aria-label": "Předchozí", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-6 h-6 sm:w-8 sm:h-8" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: `/gallery/${galleryImages[selectedIndex].src}`, alt: galleryImages[selectedIndex].alt, className: "max-h-[90vh] max-w-[90vw] object-contain rounded-md shadow-2xl", onClick: (e) => e.stopPropagation() }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "absolute right-2 sm:right-4 md:right-10 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3 sm:p-4 transition-all", onClick: handleNext, "aria-label": "Další", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-6 h-6 sm:w-8 sm:h-8" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-6 left-1/2 -translate-x-1/2 text-white/80 text-sm bg-black/50 px-4 py-2 rounded-full backdrop-blur-md", children: [
        selectedIndex + 1,
        " / ",

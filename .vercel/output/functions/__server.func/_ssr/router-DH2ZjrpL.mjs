...
import { P as Phone, M as Mail, a as MessageCircle } from "../_libs/lucide-react.mjs";
...
function StickyHeader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/70", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-14 max-w-6xl items-center justify-between px-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-6 md:flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/galerie", className: "text-sm font-bold text-ember hover:text-soot transition-colors", children: "📸 Naše Galerie" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-6 px-4 py-10 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base font-extrabold uppercase tracking-wide text-ember", children: "Máme na to koule" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/kominici-logo.png", alt: "Společenstvo kominíků ČR", className: "h-12 w-auto object-contain" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs font-bold text-muted-foreground leading-tight", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 space-y-2 text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block font-bold text-soot", children: "Vladan Husařík" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs", children: "IČO: 88883736" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 grid grid-cols-2 gap-2 text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/galerie", className: "hover:text-soot transition-colors text-ember font-semibold", children: "Galerie" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border py-4 text-center text-xs text-muted-foreground", children: [
      ...
      " VH Kominictví · IČO 88883736"
    ] })
  ] });
}
function MobileCallBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-background/95 p-2 backdrop-blur md:hidden", style: { paddingBottom: "max(0.5rem, env(safe-area-inset-bottom))" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
...
const appCss = "/assets/styles-DNpUHgdp.css";
...
const Route$6 = createFileRoute("/galerie")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Prohlédněte si ukázky naší práce. Frézování, vložkování, čištění a stavby komínů v oblasti Kryry, Louny, Žatec, Rakovník a širokém okolí."
    }]
  }),

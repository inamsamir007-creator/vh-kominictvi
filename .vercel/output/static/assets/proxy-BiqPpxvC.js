import { r as P, j as Ve } from "./index-Dxr5XOKA.js";
...
const W = (t) => t * 1e3,
  H = (t) => t / 1e3,
  $s = (t, e) => (e ? t * (1e3 / e) : 0),
  _s = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t,
  Eo = 1e-7,
  Ro = 12;
...
const Xs = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  ...
  nn = Ys(qs),
  Zs = Xs(nn),
  Js = (t) => (t >= 1 ? 1 : (t *= 2) < 1 ? 0.5 * nn(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
...
function jo(t, e) {
  ...
  const u = {
    ...
    process: (l) => {
      ...
      i = !0;
      const h = n;
      ((n = s), (s = h), n.forEach(c), n.clear(), (i = !1), r && ((r = !1), u.process(l)));
    },
  };
  return u;
}
...
function si(t, e) {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    m = () => {
      ...
      ((n = !1),
        x || (i.delta = s ? 1e3 / 60 : Math.max(Math.min(w - i.timestamp, No), 1)),
        (i.timestamp = w),
        (i.isProcessing = !0),
        a.process(i),
        c.process(i),
...
const {
  ...
  state: I,
  steps: ue,
} = si(typeof requestAnimationFrame < "u" ? requestAnimationFrame : G, !0);
let Kt;
function Uo() {
  Kt = void 0;
}
const j = {
  ...
  oi = ii("--"),
  Wo = ii("var(--"),
  on = (t) => (Wo(t) ? Ko.test(t.split("/*")[0].trim()) : !1),
...
const Go =
  ...
  zo = (t) => Q(0, 255, t),
  he = { ...wt, transform: (t) => Math.round(zo(t)) },
  ut = {
    test: an("rgb", "red"),
...
const Ce = { test: an("#"), parse: $o, transform: ut.transform },
  It = (t) => ({
  ...
  _o = It("vh"),
  Xo = It("vw"),
  Mn = { ...J, parse: (t) => J.parse(t) / 100, transform: (t) => J.transform(t * 100) },
  gt = {
    test: an("hsl", "hue"),
  ...
  L = {
    ...
    transform: (t) =>
      typeof t == "string" ? t : t.hasOwnProperty("red") ? ut.transform(t) : gt.transform(t),
    getAnimatableNone: (t) => {
      const e = L.parse(t);
...
function qo(t) {
  return (
    isNaN(t) && typeof t == "string" && (t.match(rn)?.length || 0) + (t.match(Yo)?.length || 0) > 0
  );
}
const ai = "number",
  li = "color",
...
function xt(t) {
  ...
  const a = e
    .replace(
      ...
      (c) => (
        L.test(c)
          ? (s.color.push(r), i.push(li), n.push(L.parse(c)))
          : c.startsWith(Jo)
            ? (s.var.push(r), i.push(Zo), n.push(c))
...
function ci({ split: t, types: e }) {
  ...
  return (s) => {
    ...
    for (let r = 0; r < n; r++)
      if (((i += t[r]), s[r] !== void 0)) {
        const o = e[r];
        o === ai ? (i += Vt(s[r])) : o === li ? (i += L.transform(s[r])) : (i += s[r]);
      }
    return i;
  };
}
...
const nr = (t) => (typeof t == "number" ? 0 : L.test(t) ? L.getAnimatableNone(t) : t),
  sr = (t, e) => (typeof t == "number" ? (e?.trim().endsWith("/") ? t : 0) : nr(t));
function ir(t) {
  const e = xt(t);
  return ci(e)(e.values.map((s, i) => sr(s, e.split[i])));
}
...
function or({ hue: t, saturation: e, lightness: n, alpha: s }) {
  ...
  if (!e) i = r = o = n;
    ...
    const a = n < 0.5 ? n * (1 + e) : n + e - n * e,
      c = 2 * n - a;
    ((i = fe(c, a, t + 1 / 3)), (r = fe(c, a, t)), (o = fe(c, a, t - 1 / 3)));
  }
  return {
...
function gr(t, e, n) {
  let s = n;
  for (let i = 1; i < mr; i++) s = s - t(s) / e(s);
  return s;
}
const pe = 0.001;
function yr({
  ...
  const a = 5 / t,
    c = gr(i, r, a);
  if (((t = W(t)), isNaN(c))) return { stiffness: E.stiffness, damping: E.damping, duration: t };
  {
...
function Qt(t = E.visualDuration, e = E.bounce) {
  ...
  const B = {
    ...
    toString: () => {
      const S = Math.min(cn(B), Jt),
        R = fi((U) => B.next(S * U).value, S, 30);
      return S + "ms " + R;
    },
    toTransition: () => {},
  };
...
function Ee({
  ...
  const h = t[0],
    ...
    p = (b) => (a === void 0 ? c : c === void 0 || Math.abs(a - b) < Math.abs(c - b) ? a : c);
  let m = n * e;
  const g = h + m,
    y = o === void 0 ? g : o(g);
  y !== g && (m = y - h);
  const v = (b) => -m * Math.exp(-b / s),
    ...
    w = (b) => {
      const B = v(b),
        S = x(b);
      ((f.done = Math.abs(B) <= u), (f.value = f.done ? y : S));
    };
  let A, D;
  const V = (b) => {
    d(f.value) &&
...
function Ct({ duration: t = 300, keyframes: e, times: n, ease: s = "easeInOut" }) {
  const i = Fo(s) ? s.map(Vn) : Vn(s),
    r = { done: !1, value: e[0] },
    o = Vr(n && n.length === e.length ? n : Ar(e), t),
    a = Sr(o, e, { ease: Array.isArray(i) ? i : Cr(e, i) });
  return { calculatedDuration: t, next: (c) => ((r.value = a(c)), (r.done = c >= t), r) };
}
const Mr = (t) => t !== null;
...
const Dr = { decay: Ee, inertia: Ee, tween: Ct, keyframes: Ct, spring: Qt };
function pi(t) {
...
class te extends un {
  ...
  initAnimation() {
    ...
    c !== Ct &&
      typeof a[0] != "number" &&
      ((this.mixKeyframes = Bt(Er, hi(a[0], a[1]))), (a = [0, 100]));
    const u = c({ ...e, keyframes: a });
    (r === "mirror" &&
      (this.mirroredGenerator = c({ ...e, keyframes: [...a].reverse(), velocity: -o })),
...
const ht = (t) => (t * 180) / Math.PI,
  ...
  Fn = (t) => Math.sqrt(t[4] * t[4] + t[5] * t[5]),
  kr = {
    x: 12,
    y: 13,
    z: 14,
...
class hn {
  ...
  scheduleResolve() {
    ((this.state = "scheduled"),
      this.isAsync
        ? (ft.add(this), Fe || ((Fe = !0), M.read(gi), M.resolveKeyframes(mi)))
...
const Kr = fn(() => window.ScrollTimeline !== void 0, "scrollTimeline"),
  bu = fn(() => window.ViewTimeline !== void 0, "viewTimeline"),
  vi = fn(() => {
    try {
...
const Pi = { anticipate: Js, backInOut: Zs, circInOut: ti };
function zr(t) {
  return t in Pi;
}
function $r(t) {
  typeof t.ease == "string" && zr(t.ease) && (t.ease = Pi[t.ease]);
}
const me = 10;
class _r extends wi {
  constructor(e) {
  ...
  updateMotionValue(e) {
    ...
    const a = new te({ ...o, autoplay: !1 }),
      c = Math.max(me, j.now() - this.startTime),
      u = Q(0, me, c - me),
      l = a.sample(c).value,
      { name: h } = this.options;
    (r && h && yi(r, h, l), n.setWithVelocity(a.sample(Math.max(0, c - u)).value, l, u), a.stop());
  }
}
const jn = (t, e) =>
  e === "zIndex"
...
function Yr(t, e, n, s) {
  ...
  const r = t[t.length - 1],
    o = jn(i, e),
    a = jn(r, e);
  return !o || !a ? !1 : Xr(t) || ((n === "spring" || Ti(n)) && s);
}
function je(t) {
...
const Jr = new Set([
  ...
  Qr = zs(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
function ta(t) {
  const {
    motionValue: e,
    name: n,
...
class na extends un {
  ...
  onKeyframesResolved(e, n, s, i) {
    ...
    const { name: r, type: o, velocity: a, delay: c, isHandoff: u, onUpdate: l } = s;
    this.resolvedAt = j.now();
    let h = !0;
    Yr(e, r, o, a) ||
      ((h = !1),
      (st.instantAnimations || !c) && l?.(re(e, s, n)),
      (e[0] = e[e.length - 1]),
      je(s),
      (s.repeat = 0));
    const d = {
...
class ia {
  ...
  setCurrent(e) {
    ((this.current = e),
      ...
      this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = sa(this.current)));
  }
  ...
  get() {
    return (Un.current && Un.current.push(this), this.current);
  }
  getPrevious() {
    return this.prev;
  }
...
const Ci = new Set(["width", "height", "top", "left", "right", "bottom", ...Pt]),
...
function xa({ protectedKeys: t, needsAnimating: e }, n) {
...
function Ei(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const p in a) {
    ...
    m.start(pn(p, m, g, w && Ci.has(p) ? { type: !1 } : y, t, x));
    const A = m.animation;
    A && h.push(A);
  }
  if (o) {
...
function We(t, e, n = {}) {
  ...
  const r = s ? () => Promise.all(Ei(t, s, n)) : () => Promise.resolve(),
    o =
      t.variantChildren && t.variantChildren.size
        ? (c = 0) => {
            const { delayChildren: u = 0, staggerChildren: l, staggerDirection: h } = i;
            return Ta(t, e, c, u, l, h, n);
          }
        : () => Promise.resolve(),
    { when: a } = i;
  if (a) {
  ...
  for (const c of t.variantChildren)
    (c.notify("AnimationStart", e),
      a.push(
        We(c, e, {
          ...o,
          delay: n + (typeof s == "function" ? 0 : s) + bi(t.variantChildren, c, s, i, r),
...
function Ra(t, e, n) {
  ...
  for (; s < t.length && !i; ) {
    const r = t[s];
    (typeof r == "string" && !Ea.has(r) && xt(r).values.length && (i = t[s]), s++);
  }
  if (i && n) for (const r of e) t[r] = Bi(n, i);
}
class La extends hn {
...
function ka(t) {
  return Hs(t) && "offsetHeight" in t && !("ownerSVGElement" in t);
}
const { schedule: yn, cancel: Au } = si(queueMicrotask, !1),
  $ = { x: !1, y: !1 };
function Ii() {
  return $.x || $.y;
}
...
function Ka(t, e, n = {}) {
  const [s, i, r] = Oi(t, n),
    o = (a) => {
      ...
      if (!zn(a) || $n.has(a)) return;
      (Ht.add(c), n.stopPropagation && $n.add(a));
      const u = e(c, a),
        l = (d, p) => {
        ...
        h = (d) => {
          l(d, c === window || c === document || n.useGlobalTarget || ji(c, d.target));
        },
        f = (d) => {
          l(d, !1);
        };
  ...
  return (
    s.forEach((a) => {
      ((n.useGlobalTarget ? window : a).addEventListener("pointerdown", o, i),
        ka(a) &&
          (a.addEventListener("focus", (u) => Wa(u, i)),
...
let zt;
const Ni = (t, e, n) => (s, i) =>
    i && i[0] ? i[0][t + "Size"] : xn(s) && "getBBox" in s ? s.getBBox()[e] : s[n],
  Ha = Ni("inline", "width", "offsetWidth"),
  Ga = Ni("block", "height", "offsetHeight");
...
const Tn = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"],
  wn = ["initial", ...Tn];
function le(t) {
  return ae(t.animate) || wn.some((e) => Lt(t[e]));
}
function Ui(t) {
...
class ol {
    ...
    ((this.current = e),
      ...
      this.reducedMotionConfig === "never"
        ...
        : this.reducedMotionConfig === "always"
          ...
          : (Wi.current || sl(), (this.shouldReduceMotion = ze.current)),
  ...
  bindToMotionValue(e, n) {
    if (
      ...
      n.accelerate && Si.has(e) && this.current instanceof HTMLElement)
    ) {
      const { factory: o, keyframes: a, times: c, ease: u, duration: l } = n.accelerate,
        h = new wi({
  ...
  readValue(e, n) {
    ...
    return (
      s != null &&
        (typeof s == "string" && (Ks(s) || Gs(s))
          ? (s = parseFloat(s))
          : !Qa(s) && _.test(n) && (s = Bi(e, n)),
...
function ct(t) {
  return $e(t) || zi(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
}
function zi(t) {
...
function ll(t, e, n, s = !1) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    (c && c.props.style && c.props.style.display === "contents") ||
      ...
      o && ((e.x *= o.x.scale), (e.y *= o.y.scale), $i(t, o)),
      s && ct(r.latestValues) && _t(t, r.latestValues, r.layout?.layoutBox));
  }
...
function _i(t, e) {
  return Gi(al(t.getBoundingClientRect(), e));
}
function cl(t, e, n) {
  const s = _i(t, n),
    { scroll: i } = e;
...
function Xi(t, { style: e, vars: n }, s, i) {
  const r = t.style;
  let o;
  for (o in e) r[o] = e[o];
...
function Yi(t, { layout: e, layoutId: n }) {
  return (
...
function Sn(t, e, n) {
  ...
  if (!s) return r;
  for (const o in s)
    (O(s[o]) || (i && O(i[o])) || Yi(o, t) || n?.getValue(o)?.liveStyle !== void 0) &&
      (r[o] = s[o]);
  return r;
}
function pl(t) {
...
class ml extends Hi {
  ...
  readValueFromInstance(e, n) {
    if (St.has(n)) return this.projection?.isProjecting ? ke(n) : Br(e, n);
    {
      const s = pl(e),
...
function qi(
  ...
  for (const d of xl) h[d] !== void 0 && ((f[d] = h[d]), delete h[d]);
  (e !== void 0 && (h.x = e),
    n !== void 0 && (h.y = n),
    s !== void 0 && (h.scale = s),
...
function Tl(t, e, n, s) {
  Xi(t, e, void 0, s);
  for (const i in e.attrs) t.setAttribute(Zi.has(i) ? i : gn(i), e.attrs[i]);
}
function Qi(t, e, n) {
  const s = Sn(t, e, n);
  for (const i in t)
...
class wl extends Hi {
  ...
  readValueFromInstance(e, n) {
    ...
    return ((n = Zi.has(n) ? n : gn(n)), e.getAttribute(n));
  }
  scrapeMotionValuesFromProps(e, n, s) {
    return Qi(e, n, s);
  }
...
function Vl(t) {
  let e = Al(t),
    ...
    i = !1;
  const r = (u) => (l, h) => {
    const f = dt(t, h, u === "exit" ? t.presenceContext?.custom : void 0);
    if (f) {
  ...
  function a(u) {
    ...
    for (let y = 0; y < bl; y++) {
      ...
      const b = Cl(x.prevProp, w);
      let B = b || (v === u && x.isActive && !V && A) || (y > m && A),
        S = !1;
      ...
      for (const F in X) {
        ...
        let pt = !1;
        (Ne(K) && Ne(at) ? (pt = !eo(K, at) || b) : (pt = K !== at),
          pt
            ? K != null
              ? tt(F)
              : d.add(F)
          ...
          ...R.map((F) => {
            ...
            if (typeof F == "string" && (s || i) && !Y && t.manuallyAnimateOnMount && t.parent) {
              ...
              if (at.enteringChildren && pt) {
                const { delayChildren: Vo } = pt.transition || {};
                K.delay = bi(at.enteringChildren, t, Vo);
              }
            }
...
function Bl(t, e = 0, n = 1, s = 0.5, i, r = t, o = t) {
  ...
  (t === r && (a -= e), (t.min = cs(t.min, e, n, a, i)), (t.max = cs(t.max, e, n, a, i)));
}
...
function Ul(t, e, n, s, i, r) {
  ...
  for (let o = 0; o < Nl; o++) {
    ...
    (c || (c = 0),
      u || (u = 0),
      c === 0 || u === 0 || vs(c) === vs(u)
        ? ((t[a] = Math.max(C(ys(c), ys(u), s), 0)), (J.test(u) || J.test(c)) && (t[a] += "%"))
        : (t[a] = u));
  }
...
function co({
  ...
  return class {
    ...
    mount(o) {
      ...
      ((this.isSVG = xn(o) && !Za(o)), (this.instance = o));
          ...
          t(o, () => {
            ...
            d !== h &&
              ...
              Yt.hasAnimatedSinceResize &&
                ((Yt.hasAnimatedSinceResize = !1), this.nodes.forEach(Ps)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: l, hasLayoutChanged: h, hasRelativeLayoutChanged: f, layout: d }) => {
              ...
              const p = this.options.transition || u.getDefaultTransition() || uc,
                { onLayoutAnimationStart: m, onLayoutAnimationComplete: g } = u.getProps(),
                y = !this.targetLayout || !oo(this.targetLayout, d),
                v = !h && f;
              if (
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(rc), this.animationId++);
    }
    ...
    willUpdate(o = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && lo(this),
    ...
    resetTransform() {
      ...
      const o = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout,
        a = this.projectionDelta && !io(this.projectionDelta),
        c = this.getTransformTemplate(),
        u = c ? c(this.latestValues, "") : void 0,
        l = u !== this.prevTransformTemplateValue;
      o &&
        this.instance &&
        (a || ct(this.latestValues) || l) &&
    ...
    measurePageBox() {
      ...
      if (!(this.scroll?.wasRoot || this.path.some(fc))) {
        ...
        u && (Z(a.x, u.offset.x), Z(a.y, u.offset.y));
      }
      return a;
    }
    ...
    applyTransform(o, a = !1, c) {
      ...
      for (let l = 0; l < this.path.length; l++) {
        ...
        (!a &&
          ...
          h.scroll &&
          h !== h.root &&
          (Z(u.x, -h.scroll.offset.x), Z(u.y, -h.scroll.offset.y)),
          ct(h.latestValues) && _t(u, h.latestValues, h.layout?.layoutBox));
      }
      return (ct(this.latestValues) && _t(u, this.latestValues, this.layout?.layoutBox), u);
    }
    removeTransform(o) {
      const a = k();
      z(a, o);
      for (let c = 0; c < this.path.length; c++) {
        const u = this.path[c];
        if (!ct(u.latestValues)) continue;
        let l;
        (u.instance &&
          ($e(u.latestValues) && u.updateSnapshot(), (l = k()), z(l, u.measurePageBox())),
          hs(a, u.latestValues, u.snapshot?.layoutBox, l));
      }
      return (ct(this.latestValues) && hs(a, this.latestValues), a);
    }
    setTargetDelta(o) {
          ...
          this.relativeParent.target
            ...
            : this.targetDelta
              ? (this.resumingFrom
                ...
                $i(this.target, this.targetDelta))
              : z(this.target, this.layout.layoutBox),
          this.attemptToResolveRelativeTarget &&
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || $e(this.parent.latestValues) || zi(this.parent.latestValues)))
    ...
    createRelativeTarget(o, a, c) {
      ((this.relativeParent = o),
        ...
        ie(this.relativeTargetOrigin, a, c, this.options.layoutAnchor || void 0),
    ...
    setAnimationOrigin(o, a = !1, c) {
      ...
      const d = k(),
        ...
        x = !!(g && !v && this.options.crossfade === !0 && !this.path.some(cc));
      this.animationProgress = 0;
      let w;
      ...
      ((this.mixTargetDelta = (D) => {
        ...
        (b
          ...
          this.relativeTarget &&
            ...
            lc(this.relativeTarget, this.relativeTargetOrigin, d, V),
            w && Ol(this.relativeTarget, w) && (this.isProjectionDirty = !1),
            w || (w = k()),
            z(w, this.relativeTarget)),
          g && ((this.animationValues = h), Ul(h, l, this.latestValues, V, x, v)),
          b &&
            b.rotate !== void 0 &&
    ...
    applyTransformsToTarget() {
      ...
      if (!(!a || !c || !u)) {
        if (
          ...
          this.layout &&
          u &&
          uo(this.options.animationType, this.layout.layoutBox, u.layoutBox)
        ) {
          c = this.target || k();
        ...
        (z(a, c), _t(a, l), Mt(this.projectionDeltaWithTransform, this.layoutCorrected, a, l));
      }
    }
    ...
    resetSkewAndRotation() {
      ...
      if (
        ...
        return;
      const u = {};
      c.z && xe("z", o, u, this.animationValues);
      for (let l = 0; l < ve.length; l++)
        (xe(`rotate${ve[l]}`, o, u, this.animationValues),
          xe(`skew${ve[l]}`, o, u, this.animationValues));
      o.render();
      for (const l in u)
    ...
    applyProjectionStyles(o, a) {
      ...
      this.options.layoutId && (o.pointerEvents = u === this ? Xt(a?.pointerEvents) || "" : "none");
    }
    clearSnapshot() {
...
const uc = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
  ...
  Vs = As("applewebkit/") && !As("chrome/") ? Math.round : G;
function Cs(t) {
...
function uo(t, e, n) {
  return t === "position" || (t === "preserve-aspect" && !Ll(ms(e), ms(n), 0.2));
}
function fc(t) {
...
const dc = co({
  ...
  fo = P.createContext({ transformPagePoint: (t) => t, isStatic: !1, reducedMotion: "never" });
function pc(t = !0) {
...
const po = P.createContext({ strict: !1 }),
  Ms = {
    animation: [
      "animate",
      "variants",
...
let go = (t) => !oe(t);
function vc(t) {
  typeof t == "function" && (go = (e) => (e.startsWith("on") ? !oe(e) : t(e)));
}
try {
...
function wc(t) {
  const { initial: e, animate: n } = Tc(t, P.useContext(ce));
...
function yo(t, e, n) {
  for (const s in e) !O(e[s]) && !Yi(s, n) && (t[s] = e[s]);
}
function Pc({ transformTemplate: t }, e) {
  return P.useMemo(() => {
    const n = bn();
...
function Sc(t, e) {
  const n = t.style || {},
    s = {};
  return (yo(s, n, t), Object.assign(s, Pc(t, e)), s);
}
function bc(t, e) {
  const n = {},
    s = Sc(t, e);
...
function Ac(t, e, n, s) {
  const i = P.useMemo(() => {
    const r = vo();
    return (qi(r, e, Ji(s), t.transformTemplate, t.style), { ...r.attrs, style: { ...r.style } });
  }, [e]);
  if (t.style) {
    const r = {};
    (yo(r, t.style, t), (i.style = { ...r, ...i.style }));
  }
  return i;
}
const Vc = [
...
function An(t) {
  return typeof t != "string" || t.includes("-") ? !1 : !!(Vc.indexOf(t) > -1 || /[A-Z]/u.test(t));
}
function Cc(t, e, n, { latestValues: s }, i, r = !1, o) {
  const c = ((o ?? An(t)) ? Ac : bc)(e, s, i, t),
    u = xc(e, typeof t == "string", r),
    l = t !== P.Fragment ? { ...u, ...c, ref: n } : {},
    { children: h } = e,
    f = P.useMemo(() => (O(h) ? h.get() : h), [h]);
  return P.createElement(t, { ...l, children: f });
}
function Mc({ scrapeMotionValuesFromProps: t, createRenderState: e }, n, s, i) {
...
const xo = (t) => (e, n) => {
    const s = P.useContext(ce),
      i = P.useContext(Je),
      r = () => Mc(t, e, s, i);
    return n ? r() : Co(r);
  },
  Ec = xo({ scrapeMotionValuesFromProps: Sn, createRenderState: bn }),
  Rc = xo({ scrapeMotionValuesFromProps: Qi, createRenderState: vo }),
  Lc = Symbol.for("motionComponentSymbol");
function kc(t, e, n) {
  const s = P.useRef(n);
...
function Bc(t, e, n, s, i, r) {
  const { visualElement: o } = P.useContext(ce),
    a = P.useContext(po),
    c = P.useContext(Je),
    u = P.useContext(fo),
    l = u.reducedMotion,
  ...
  const p = f.current,
    m = P.useContext(To);
  p && !p.projection && i && (p.type === "html" || p.type === "svg") && Fc(f.current, n, i, m);
  const g = P.useRef(!1);
  P.useInsertionEffect(() => {
...
function we(t, { forwardMotionProps: e = !1, type: n } = {}, s, i) {
  ...
  function a(u, l) {
    let h;
    const f = { ...P.useContext(fo), ...u, layoutId: Ic(u) },
      { isStatic: d } = f,
      p = wc(u),
      m = o(u, d);
    if (!d && typeof window < "u") {
      Oc();
      const g = jc(f);
      ((h = g.MeasureLayout), (p.visualElement = Bc(t, m, f, i, g.ProjectionNode, r)));
    }
    return Ve.jsxs(ce.Provider, {
      value: p,
      children: [
        h && p.visualElement ? Ve.jsx(h, { visualElement: p.visualElement, ...f }) : null,
        Cc(t, u, kc(m, p.visualElement, l), m, d, e, r),
      ],
    });
  }
...
const Uc = (t, e) =>
  (e.isSVG ?? An(t)) ? new wl(e) : new ml(e, { allowProjection: t !== P.Fragment });
class Wc extends ot {
  constructor(e) {
...
const Gc = { animation: { Feature: Wc }, exit: { Feature: Hc } };
function Ot(t) {
  return { point: { x: t.pageX, y: t.pageY } };
}
const zc = (t) => (e) => vn(e) && t(e, Ot(e));
function Dt(t, e, n, s) {
  return kt(t, e, zc(n), s);
}
const Po = ({ current: t }) => (t ? t.ownerDocument.defaultView : null),
  Rs = (t, e) => Math.abs(t - e);
function $c(t, e) {
  const n = Rs(t.x, e.x),
    s = Rs(t.y, e.y);
...
class So {
  constructor(
    ...
    if (
      ...
      (this.updatePoint = () => {
        ...
        const d = Pe(this.lastMoveEventInfo, this.history),
          ...
          m = $c(d.offset, { x: 0, y: 0 }) >= this.distanceThreshold;
        if (!p && !m) return;
        const { point: g } = d,
          { timestamp: y } = I;
    ...
    const c = Ot(e),
      u = Ut(c, this.transformPagePoint),
      { point: l } = u,
      { timestamp: h } = I;
    this.history = [{ ...l, timestamp: h }];
    const { onSessionStart: f } = n;
    (f && f(e, Pe(u, this.history)),
...
function Pe({ point: t }, e) {
  return { point: t, delta: ks(t, bo(e)), offset: ks(t, _c(e)), velocity: Xc(e, 0.1) };
}
function _c(t) {
  return t[0];
}
...
function qc(t, { top: e, left: n, bottom: s, right: i }) {
...
class nu {
  ...
  start(e, { snapToCursor: n = !1, distanceThreshold: s } = {}) {
    ...
    this.panSession = new So(
      e,
      { onSessionStart: r, onStart: o, onMove: a, onSessionEnd: c, resumeAnimation: u },
      {
  ...
  updateAxis(e, n, s) {
    ...
    (this.constraints && this.constraints[e] && (o = Yc(o, this.constraints[e], this.elastic[e])),
      r.set(o));
  }
  resolveConstraints() {
    ...
    (e && mt(e)
      ...
      : e && s
        ? (this.constraints = qc(s.layoutBox, e))
        : (this.constraints = !1),
      (this.elastic = tu(n)),
      i !== this.constraints &&
        !mt(e) &&
        ...
        q((r) => {
          this.constraints !== !1 &&
            ...
            (this.constraints[r] = Qc(s.layoutBox[r], this.constraints[r]));
        }));
  }
  resolveRefConstraints() {
    ...
    const r = cl(s, i.root, this.visualElement.getTransformPagePoint());
    let o = Zc(i.layout.layoutBox, r);
    if (n) {
      const a = n(rl(o));
  ...
  startAxisValueAnimation(e, n) {
    ...
    return (Ue(this.visualElement, e), s.start(pn(e, s, 0, n, this.visualElement, !1)));
  }
  stopAnimation() {
  ...
  scalePositionWithinConstraints() {
    ...
    q((o) => {
      ...
      if (a && this.constraints !== !1) {
        const c = a.get();
        i[o] = Jc({ min: c, max: c }, this.constraints[o]);
      }
    });
  ...
  addListeners() {
    ...
    const i = () => {
        ...
        mt(u) &&
          ...
          s || (s = su(e, u.current, () => this.scalePositionWithinConstraints())));
      },
    ...
    const a = kt(window, "resize", () => this.scalePositionWithinConstraints()),
      c = r.addEventListener("didUpdate", ({ delta: u, hasLayoutChanged: l }) => {
        this.isDragging &&
          l &&
          (q((h) => {
...
class ru extends ot {
  ...
  onPointerDown(e) {
    this.session = new So(e, this.createPanHandlers(), {
...
const lu = { pan: { Feature: ru }, drag: { Feature: ou, ProjectionNode: ho, MeasureLayout: Ao } };
function Ns(t, e, n) {
  const { props: s } = t;
...
class cu extends ot {
  mount() {
    ...
    e &&
      (this.unmount = Ia(e, (n, s) => (Ns(this.node, s, "Start"), (i) => Ns(this.node, i, "End"))));
  }
  unmount() {}
}
class uu extends ot {
...
class yu extends ot {
  ...
  startObserver() {
    ...
    this.stopObserver = mu(this.node.current, o, a);
  }
  mount() {
    this.startObserver();
  }
...
const xu = {
  ...
  Tu = { layout: { ProjectionNode: ho, MeasureLayout: Ao } },
  wu = { ...Gc, ...xu, ...lu, ...Tu },
  Cu = Nc(wu, Uc);
export {
  fo as M,

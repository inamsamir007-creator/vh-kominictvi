...
export function CoverageSection() {
  return (
    <section id="oblast" className="scroll-mt-20 border-y border-border bg-card py-20 md:py-28 overflow-hidden">
            ...
            {groups.map((g, i) => (
              ...
              >
                ...
                <ul className="mt-4 flex flex-wrap gap-2">
                  {g.towns.map((t) => (
                    <li key={t} className="rounded-full bg-muted px-3 py-1 text-sm text-soot transition-colors hover:bg-ember/10 hover:text-ember">
                      {t}
                    </li>
                  ))}
                </ul>

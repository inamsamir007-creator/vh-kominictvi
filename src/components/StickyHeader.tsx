      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
        ...
        <div className="hidden items-center gap-6 md:flex">
          <div className="flex items-center gap-3 border-r border-border/60 pr-6">
            <a href="https://www.facebook.com/vhkominictvicz/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-blue-600 transition-colors" aria-label="Facebook">
              <Facebook className="h-5 w-5" />
            </a>
            <a href="https://maps.app.goo.gl/tvk12uiNMT5JsqND9" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-emerald-600 transition-colors" aria-label="Google Business Profile">
              <MapPin className="h-5 w-5" />
            </a>
          </div>
          <Link to="/galerie" className="text-sm font-bold text-ember hover:text-soot transition-colors">
            📸 Naše Galerie
          </Link>
          <a
            href={PHONE_HREF}

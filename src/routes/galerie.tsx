...
const galleryImages = [
  ...
  { src: "101455e9-6a4f-423b-854d-76557247f5cb.jpg", alt: "Vložkování komína Podbořany - realizace" },
  { src: "146e1133-c246-46d5-a92d-aa8aa9267893.jpg", alt: "Kominické práce Rakovník - na střeše" },
  ...
  { src: "635fc761-1aed-4fd0-9aae-0333dc7a4396.jpg", alt: "Čistý komín po frézování Nové Strašecí" },
  ...
  { src: "69b23e2f-e12f-4650-9435-2fcfa4cdaed2.jpg", alt: "Nová krbová vložka a připojení Kaznějov" },
  { src: "6fbbac67-cf85-4947-99ee-dad8b30f8a71.jpg", alt: "Kominické nářadí a příprava na práci" },
  { src: "75d2b4b6-747c-46c6-a8ef-4520e4f10426.jpg", alt: "Zabezpečení komína proti povětrnostním vlivům" },
  ...
  { src: "b12d0057-0246-427a-9b49-5c0b8b5bc5f6.jpg", alt: "Profesionální čištění spalinové cesty" },
  { src: "b34e9bbf-bd5e-46eb-8b3e-95baee12e3a4.jpg", alt: "Společenstvo kominíků ČR certifikace v praxi" },
  ...
  return (
    <div className="bg-background min-h-screen py-16 md:py-24 pb-20 md:pb-24">
      <div className="mx-auto max-w-6xl px-4">
        ...
        >
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-ember">Naše práce</p>
          <h1 className="mt-2 text-4xl font-extrabold text-soot md:text-5xl">
            Galerie realizací
          </h1>
      ...
      {selectedIndex !== null && (
        ...
        >
          ...
          <button 
            className="absolute left-2 sm:left-4 md:left-10 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3 sm:p-4 transition-all"
            onClick={handlePrev}
          ...
          <button 
            className="absolute right-2 sm:right-4 md:right-10 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full p-3 sm:p-4 transition-all"
            onClick={handleNext}
            aria-label="Další"
          >
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white/80 text-sm bg-black/50 px-4 py-2 rounded-full backdrop-blur-md">

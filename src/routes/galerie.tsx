    ...
    <div className="bg-background min-h-screen py-16 md:py-24 pb-20 md:pb-24">
      <div className="mx-auto max-w-6xl px-4">
        ...
        >
          ...
          <h1 className="mt-2 text-4xl font-extrabold text-soot md:text-5xl">Galerie realizací</h1>
          <p className="mt-4 text-lg text-muted-foreground">
            Podívejte se na ukázky naší kominické práce — od běžného čištění přes frézování a
            vložkování komínů až po montáže na klíč v širokém okolí města Kryry.
          </p>
        </motion.header>
